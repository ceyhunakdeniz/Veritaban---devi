...
using Akdeniz_Hırdavat.BL;
using Akdeniz_Hırdavat.UI;
...
namespace Akdeniz_Hırdavat
{
    public partial class AnaForm : Form
    {
        ...
        readonly Müşteriler mf = new Müşteriler();
        readonly Ürünler uf = new Ürünler();
